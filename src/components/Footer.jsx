...
import Logo from "../assets/images/Frame 25.svg";
      ...
      <div className="Landing-footer">
        <div className="footer-section contact-info">
          <div style={{ display: "flex", marginBottom: "3%" }}>
            <img src={Logo} href="/" alt="Logo-icon"></img>
          </div>
        ...
        <div className="footer-section resources">
          ...
          <a href="#Search" style={{ marginBottom: "3%" }}>
            Search
          </a>
          <a href="#AboutUs" style={{ marginBottom: "3%" }}>
            About Us
          </a>
          <a href="#WhyInfer" style={{ marginBottom: "3%" }}>
            Why Infer?
          </a>
        </div>
