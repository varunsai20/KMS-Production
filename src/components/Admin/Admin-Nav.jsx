...
const AdminNav = () => {
  ...
  useEffect(() => {
    ...
    } else if (location.pathname === '/admin/researchers') {
    ...
    <div className="sidebar">
      <div className='sidebar-components'>
        <div className="sidebar-header">
          <img src={Logo} alt="Infer Logo" className="logo" />
        </div>
        <ul className="sidebar-nav">
          ...
          <img src={Dashboard} alt="Dashboard" className="nav-icon" />
            ...
            <Link to="/admin/admins" onClick={() => setActiveItem('Admins')}>
          <li className={`nav-item ${activeItem === 'Admins' ? 'active' : ''}`}>
          <img src={Admin} alt="Admins" className="nav-icon" />
              <span>Admins</span>
          </li>
            </Link>
            <Link to="/" onClick={() => setActiveItem('My Profile')}>
